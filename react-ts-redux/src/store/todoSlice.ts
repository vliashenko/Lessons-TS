...
//posts/requests.ts
export const getPosts = createAsyncThunk<IPost[], undefined>(
    'posts/fetchPosts',
    async () => {
        const response = axios.get('https://api.svitlofour.com/posts');
    ...
    //     const response = await fetch('https://api.svitlofour.com/posts');
